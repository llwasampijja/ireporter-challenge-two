...
class IncidentController:
    ...
    def update_incident(self, incident_id, request_data, keyword, username):
        ...
        update_incident_instance = incident_data.update_incident(
            incident_id, request_data, keyword, username)
        return self.delete_update(update_incident_instance, RESP_UNAUTHORIZED_EDIT, self.response_sumission_success(update_incident_instance,
                                                   "update"))
    ...
    def delete_incident(self, incident_id, keyword, username):
        delete_incident_instance = incident_data.delete_incident(
            incident_id, keyword, username)
        return self.delete_update(delete_incident_instance, RESP_UNAUTHORIZED_DELETE, self.response_sumission_success(delete_incident_instance,
                                                   "delete"))
