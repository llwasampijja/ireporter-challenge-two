...
RESP_ALREADY_TAKEN = "Attempting to register with an Email address, \
phonenumber or username  which is/are registered on the system"
...
nothing more. The only accepted values include: 'pending investigation', \
...
RESP_INCIDENT_UPDATE_SUCCESS = "Updated incident record’s location successfully"
RESP_INCIDENT_LIST_EMPTY = "Incidents list is empty"
RESP_INCIDENT_STATUS_UPDATE_SUCCESS = "Updated incident record’s status successfully"
RESP_INCIDENT_WROND_STATUS = "Wrong Status given"
RESP_ADMIN_ONLY = "This feature is only available to adminitrators"
RESP_INCIDENT_DELETE_SUCCESS = "Incident was deleted successfully"
